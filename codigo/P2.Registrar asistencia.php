...
<html lang="es">
<!-- Esta vaina no tiene su propio archivo CSS :v , solo usa el archivo sidebar para hacer el header -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="main-box no-header clearfix">
                    <div class="main-box-body clearfix">
                        <div class="container ml-4">
                            <div>
                                <h1 class="texto-azul">Registro de Asistencia: <?php echo $_SESSION['datos_usuario']['especialidad'] ?></h1>
                                <!-- <h2>Curso:</h2> -->
